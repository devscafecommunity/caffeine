...
- **Downstream:** [Audio](audio.md) (reage a colisões), [Fase 5 — Spatial Partitioning](../physics/spatial-partitioning.md)
...
- [`docs/core/events.md`](../core/events.md) — `OnCollision2D` event
