...
During \texttt{beginFrame()}, the following operations occur:
\begin{enumerate}
    \item Copy \texttt{m_keyState} to \texttt{m_prevKeyState}.
    \item Copy \texttt{m_mouseState} to \texttt{m_prevMouseState}.
