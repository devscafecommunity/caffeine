...
O Timer fornece medições de tempo de alta precisão (microssegundos) para o [Game Loop](game-loop.md) e o [Profiler](../debug/debug-tools.md). Usa `SDL_GetPerformanceCounter` internamente, que acessa o hardware clock da plataforma.
...
- **Downstream:** [Game Loop](game-loop.md), [Profiler](../debug/debug-tools.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Concorrência & Runtime]() | Timer como base do Game Loop e Profiler |
...
- [`debug/debug-tools.md`](../debug/debug-tools.md) — Profiler usa ScopeTimer
