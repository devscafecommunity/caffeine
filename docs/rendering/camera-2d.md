...
- **Upstream:** [Fase 1 — Mat4, Vec2](../math/vectors.md), [Fase 4 — ECS Entity](../ecs/core.md)
- **Downstream:** [Batch Renderer](batch-renderer.md), [Fase 5 — Camera3D](../rendering/camera-3d.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Renderização & Pipeline]() | Camera 2D na pipeline de renderização |
...
- [`docs/fase5/camera3d.md`](../rendering/camera-3d.md) — extensão para 3D
