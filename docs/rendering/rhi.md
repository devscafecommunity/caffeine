...
- **Downstream:** [Batch Renderer](batch-renderer.md), [Debug Tools](../debug/debug-tools.md) (DebugDraw), [Fase 4 — UI](../ui/game-ui.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Renderização & Pipeline]() | RHI como abstração da GPU |
