...
Na Fase 6, o Profiler e Log serão expostos via [Caffeine Studio](../ui/editor-ui.md):
...
- **Upstream:** [Timer](../core/timer.md) (ScopeTimer usa TimePoint), `Caffeine::Core::Types`
- **Downstream:** [Fase 3 — RHI](../rendering/rhi.md) (DebugDraw precisa de CommandBuffer), [Fase 6 — Studio](../ui/editor-ui.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Editor & Debug]() | Debug Tools como base do editor |
| [Concorrência & Runtime]() | Profiler monitora concorrência |

## Referências

- [`docs/architecture_specs.md`](../architecture_specs.md) — §16 Debug/Development Tools
- [`core/timer.md`](../core/timer.md) — `ScopeTimer` RAII
- [`ui/editor-ui.md`](../ui/editor-ui.md) — ImGui UI para debug
