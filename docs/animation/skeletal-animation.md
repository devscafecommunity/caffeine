...
Extensão do [Animation System da Fase 4](../animation/animation-2d.md) para suportar skeletal animation 3D: hierarquia de bones, vertex skinning e blend trees. Carregado de arquivos `.gltf` com animações.
...
- **Upstream:** [Animation System](../animation/animation-2d.md), [3D Math](3d-math.md), [Mesh Loading](mesh-loading.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Sistemas de Jogo]() | Skeletal animation como extensão de gameplay |

## Referências

- [`animation/animation-2d.md`](../animation/animation-2d.md) — AnimationSystem base
- [`assets/mesh-loading.md`](mesh-loading.md) — carrega skeleton + clipes de .gltf
- [`math/quaternions.md`](3d-math.md) — Quaternion para interpolação de bones
