...
- **Upstream:** [Fase 1 — Memory, Containers](../memory/allocators.md), [Fase 2 — Job System](../concurrency/job-system.md)
- **Downstream:** [Scene](scene.md), [Physics](physics.md), [Animation](animation.md), [Audio](audio.md), [UI](ui.md), [Fase 3 — Batch Renderer](../rendering/batch-renderer.md)
...
| Tópico | Descrição |
|--------|-----------|
| [Sistemas de Jogo]() | ECS como base de todos os sistemas de gameplay |
| [Memória & Dados]() | ComponentPools, archetypes e layout de dados |
