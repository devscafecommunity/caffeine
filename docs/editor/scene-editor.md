...
- **Upstream:**
  - [ECS](../ecs/core.md) — `World`, `Entity`, componentes
  - [Scene Manager](../ecs/scene.md) — `SceneSerializer`
  - [Embedded UI](embedded-ui.md) — `ImGuiIntegration`
  - [RHI](../rendering/rhi.md) — framebuffer offscreen
  - [Asset Manager](../assets/asset-manager.md) — thumbnails + drop
  - [Batch Renderer](../rendering/batch-renderer.md) — renderização no viewport
- **Downstream:**
  - — (fase final)
...
| Tópico | Descrição |
|--------|-----------|
| [Editor & Debug]() | Scene Editor como coração do IDE |
| [Sistemas de Jogo]() | Editor manipula entidades ECS |

## Referências

- [`ecs/core.md`](../ecs/core.md) — ECS World e componentes
- [`ecs/scene.md`](../ecs/scene.md) — SceneSerializer
- [`ui/editor-ui.md`](embedded-ui.md) — ImGuiIntegration
- [`rendering/rhi.md`](../rendering/rhi.md) — RenderDevice
